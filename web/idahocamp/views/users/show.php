    ...
    <div class="row">
        <div class="card shadow-sm mt-3 mb-3">
          <div class="card-header text-capitalize">
            <?php if(isset($_SESSION['clientData']['full_name'])){echo "value={$_SESSION['clientData']['full_name']}";} ?>            
          </div>
          <ul class="list-group list-group-flush">
              <li class="list-group-item">
                <i class="fas fa-envelope"></i> <strong>Email: </strong><a href="mailto:<%= user.email %> "><?php if(isset($_SESSION['clientData']['email'])){echo "value={$_SESSION['clientData']['email']}";}?></a>             
              </li>                            
