<div class="mt-3">
  <footer class="footer">
    <div class="container text-center">
      <small class="text-muted"> &copy; IdahoCamping 2020 | <a class="text-muted" href="/idahocamp/views/about">About</a> | <a class="text-muted" href="https://github.com/cesarfda/Practice/yelp-camp">Github</a></small>
    </div>  
  </footer>
</div>
